...
private:
    ...
    const int TRAINING_TIME_SECONDS = 30;  // 30 minutes
    ...
    // Validation settings
    const int VALIDATION_TESTS = 10;           // Number of test runs
    const int VALIDATION_REQUIRED_WINS = 7;   // Must win 3/5 (60%) to pass
